...
&nbsp;
        ...
        <br />
         ...
         <asp:GridView ID="GridViewGra" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False" DataKeyNames="id_gra" 
         ...
         <asp:SqlDataSource ID="WyswietlGry" runat="server" 
             ConnectionString="<%$ ConnectionStrings:Sklep_GryConnectionString %>" 
             SelectCommand="SELECT [id_gra], [kod_produktu], [ilosc], [nazwa], [opis], [cena] FROM [gra]">
         </asp:SqlDataSource>
        <br />
