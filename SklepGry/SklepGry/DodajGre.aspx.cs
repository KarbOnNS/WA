...
namespace SklepGry
{
    ...
    {
        SqlConnection con = new SqlConnection(WebConfigurationManager.ConnectionStrings["KarbonConnection"].ConnectionString);
        ...
        protected void DodajGreDoBazy()
        {
            try
            {
                ...
                /*id_kategoria_gry, */
                string command = "INSERT INTO gra (kod_produktu, ilosc, nazwa, opis, cena) VALUES ('" + TextBoxKod.Text + "','" + TextBoxIlosc.Text + "','" + TextBoxNazwa.Text + "','" + TextBoxOpis.Text + "','" + TextBoxCena.Text + "');";
                con.Open();
